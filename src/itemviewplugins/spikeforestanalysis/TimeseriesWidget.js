...
export default class TimeseriesWidget extends Component {
    ...
    */
    ...
    async componentDidMount() {
        ...
        this.time_axis_xrange = [this.margins.left, this.size[0] - this.margins.right];
    ...
    repaint() {
        ...
        let H0 = this.size[1] - this.margins.top - this.margins.bottom;;
        this.channel_spacing = H0 / M;
        this.channel_y_positions = [];
        let y0 = this.size[1] - this.margins.bottom - this.channel_spacing / 2;
        for (let m = 0; m < M; m++) {
    ...
    paint_main_canvas() {
        ...
        let downsample_factor = this.determine_downsample_factor_from_num_timepoints(this.size[0] * 1.3, t2 - t1);
