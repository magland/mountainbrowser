...
export function MouseHandler() {
    ...
    this.mouseDown=function(e) {report('press',mouse_event(e)); return false;};
    this.mouseUp=function(e) {report('release',mouse_event(e)); return false;};
    ...
    this.mouseWheel=function(e) {report('wheel', wheel_event(e)); return false;};
